...
target 'Target' do
  ...
  pod 'GoogleMobileAds-BidMachine-Adapters', '~> 1.7.4.0'
end
```
...
target 'Target' do
  project 'Project.xcodeproj'
  pod 'GoogleMobileAds-BidMachine-Adapters', '~> 1.7.4.0'
  pod "BDMAdColonyAdapter", "~> 1.7.4.0"
  pod "BDMAmazonAdapter", "~> 1.7.4.0"
  pod "BDMCriteoAdapter", "~> 1.7.4.0"
  pod "BDMFacebookAdapter", "~> 1.7.4.0"
  pod "BDMMyTargetAdapter", "~> 1.7.4.0"
  pod "BDMSmaatoAdapter", "~> 1.7.4.0"
  pod "BDMTapjoyAdapter", "~> 1.7.4.0"
  pod "BDMVungleAdapter", "~> 1.7.4.0"
  pod "BDMPangleAdapter", "~> 1.7.4.0"
end
```
